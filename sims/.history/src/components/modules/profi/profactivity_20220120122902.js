...
class profactivity extends React.Component {
        ...
        try {
            ...
            switch (key) {
                ...
                case "ItemPostingGroupID":
                    ...
                    break;
                case "UOMID":
                    ProformaInvoiceLine[index].UOMID = value;
                    this.setState({ ProformaInvoiceLine: ProformaInvoiceLine });
                    break;
                case "Quantity":
                    ProformaInvoiceLine[index].Quantity = value;
                    if (parseInt(ProformaInvoiceLine[index].Type === 0)) {
                        let Price=this.getPrice(parseFloat(Quantity), ProformaInvoiceLine[index]);
    ...
    Add=()=>{
        ...
        let ProformaInvoice= {
            ...
            BillingStateID: parseInt(this.state.BillingStateID),
            ...
            ShippingStateID: parseInt(this.state.ShippingStateID),
