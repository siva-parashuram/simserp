    ...
    validateLine = (o) => {
      ...
      calculateInvoiceDetails = () => {
        ...
        try {
          ...
          FCValue = IsRounding === true ? parseInt(FCValue) : FCValue.toFixed(2);
          BaseValue = IsRounding === true ? parseInt(BaseValue) : BaseValue.toFixed(2);
        } catch (e) { }
    
        this.setState({
            FCValue:FCValue,
            BaseValue:BaseValue,
          Amount: IsRounding === true ? parseInt(Amount) : Amount.toFixed(2),
          DiscountAmount: IsRounding === true ? parseInt(DiscountAmount) : DiscountAmount.toFixed(2),
          TotalTax: IsRounding === true ? parseInt(TotalTax) : TotalTax.toFixed(2),
        });
      }
