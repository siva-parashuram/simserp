        ...
        return (
            <Fragment>
                                ...
                                {this.props.state.ProformaInvoiceLine ? this.props.state.ProformaInvoiceLine.map((item, i) => (
                                    <tr className={item.isDataProper === true ? "lineSelectedRow" : "selectedRowError"}>
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    try{
                                                        if(parseInt(e.target.value)===0){
                                                            this.props.triggeronKeyDown(e,"CategoryID" + i);
                                                            // document.getElementById("CategoryID" + i).focus();
                                                        }else{
                                                            this.props.triggeronKeyDown(e,"TypeID" + i);
                                        ...
                                        <td>
                                            <CGSELECT
                                                id={"CategoryID" + i}
                                                options={item.categoryList?item.categoryList:[]}
                                        ...
                                        <td>
                                            <CGSELECT
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    try{
                                                        document.getElementById("TolerancePercentage" + i).focus();
                                                    }catch(err){
                                                        console.log("Enter Clicked err > ",err);
                                                    }
                                                }}                                               
                                        ...
                                        <td>
                                            <CGINPUT
                                                ...
                                                onKeyDown={(e)=>{
                                                    if(this.props.state.Branch.IsGST === true){
                                                        if (e.key === 'Enter' || e.keyCode === 13 || e.keyCode === 39) {
                                                            console.log("Enter Clicked > ");
                                                            
                                                            try{
                                                                document.getElementById("GSTGroupID" + i).focus();
                                                            }catch(err){
                                                                console.log("Enter Clicked err > ",err);
                                                            }                                                        
                                                        }
                ...
                <Dialog
                    ...
                    open={this.props.state.DialogStatus}
