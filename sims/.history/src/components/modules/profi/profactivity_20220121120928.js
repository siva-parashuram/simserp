                    ...
                    switch (Type) {
                        case 0:
                            ...
                            try {
                                ...
                                ProformaInvoiceLine[index].LineDiscPercentage = parseFloat(value.LineDiscPercentage);
                            ...
                            try {
                                ...
                                document.getElementById("LineDiscPercentage" + index).value = parseFloat(value.LineDiscPercentage);
