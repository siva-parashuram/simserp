...
class profi extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            BranchID: 0,
            compID: 0,
            columns: APIURLS.ProfInvMasterColumn,
            DataList: [],
            selectionModel: [0],
            filelist: [],
        }
    ...
    getAttachedFileList = () => {
        ...
        formData.append("TransactionNo", parseInt(this.state.item.ProformaID));
            ...
            <Fragment>
                ...
                >
                    ...
                    <Button
                        ...
                        onClick={(e) => openPage(URLS.URLS.addProfInv + this.state.urlparams + "&type=add")}
                                ...
                                <Table stickyHeader size="small" className="accordion-table" aria-label="table">
                                    <TableBody className="tableBody">
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell align="right" className="no-border-table">{moment(this.state.item.ProformaDate).format("MM/DD/YYYY")}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell align="left" className="no-border-table">Customer Name</TableCell>
                                            <TableCell align="right" className="no-border-table">{this.state.item.CustomerName}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                    ...
                                    <div key="paymentPendingLink" to="#" className="card-link">
                                        <Card className="dash-activity-card2" raised={false}>
                                            <CardContent>
                                                ...
                                                <Typography >
                                                    {this.state.item.FCValue ? parseFloat(this.state.item.FCValue).toFixed(2) : null}
                                                </Typography>
                                            </CardContent>
                                        </Card>
                                    </div>
                                    ...
                                    <div key="paymentPendingLink" to="#" className="card-link">
                                        <Card className="dash-activity-card2" raised={false}>
                                            <CardContent>
                                                ...
                                                <Typography>
                                                    {this.state.item.BaseValue ? parseFloat(this.state.item.BaseValue).toFixed(2) : null}
                                                </Typography>
                                            </CardContent>
                                        </Card>
                                    </div>
                                    ...
                                    <div key="paymentPendingLink" to="#" className="card-link">
                                        <Card className="dash-activity-card2" raised={false}>
                                            <CardContent>
                                                ...
                                                <Typography>
                                                    {this.state.item.ExchRate ? parseFloat(this.state.item.ExchRate).toFixed(2) : null}
                                                </Typography>
                                            </CardContent>
                                        </Card>
                                    </div>
