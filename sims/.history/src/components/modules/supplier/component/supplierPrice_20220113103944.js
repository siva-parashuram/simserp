            ...
            <Grid xs={12} sm={12} md={12} lg={12}>
              ...
              >
                ...
                <TableBody className="tableBody">
                  {console.log("------------------------ SupplierPriceList > ",this.state.SupplierPriceList)}
  ...
  createSupplierPrice = (param) => {
    ...
    if(isProperData===true){
      ...
      let newSupplierPrice = {
        ...
        BranchID: CF.toInt(SupplierPrice.BranchID)===CF.toInt(this.state.BranchID)?CF.toInt(this.state.BranchID):CF.toInt(SupplierPrice.BranchID),  //CF.toInt(this.state.BranchID)
      };
