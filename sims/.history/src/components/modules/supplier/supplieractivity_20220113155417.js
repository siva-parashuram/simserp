                ...
                <div key="paymentPendingLink" to="#" className="card-link">
                  <Card className="dash-activity-card2" raised={false}>
                    <CardContent>
                      ...
                      <Typography >
                      {this.state.Supplier.DetailsInfo?this.state.selectedItem.DetailsInfo.Orders:0}
                      </Typography>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div key="paymentPendingLink" to="#" className="card-link">
                  <Card className="dash-activity-card2" raised={false}>
                    <CardContent>
                      ...
                      <Typography>
                      {this.state.Supplier.DetailsInfo?this.state.selectedItem.DetailsInfo.Invoices:0}
                      </Typography>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div key="paymentPendingLink" to="#" className="card-link">
                  <Card className="dash-activity-card2" raised={false}>
                    <CardContent>
                      ...
                      <Typography>
                      {this.state.Supplier.DetailsInfo?this.state.selectedItem.DetailsInfo.DebitNote:0}
                      </Typography>
                    </CardContent>
                  </Card>
                </div>
