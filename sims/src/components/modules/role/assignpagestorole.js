          ...
          <Fragment>
            {params.value === true ? (
              ...
              <input
                ...
                checked={false}
                onClick={(e) =>
                  this.chkPermission(e, params, "IsCreate", false)
                }
              />
            )}
          </Fragment>
          ...
          <Fragment>
            {params.value === true ? (
              ...
              <input
                ...
                checked={false}
                onClick={(e) =>
                  this.chkPermission(e, params, "IsUpdate", false)
                }
              />
            )}
          </Fragment>
          ...
          <Fragment>
            {params.value === true ? (
              ...
              <input
                ...
                checked={false}
                onClick={(e) =>
                  this.chkPermission(e, params, "IsDelete", false)
                }
              />
            )}
          </Fragment>
              ...
              {this.state.refreshPageLinkList === true ? (
                <DataGrid
                  ...
                  isRowSelectable={(params) =>
                    params.row.IsCreate === true ||
                    params.row.IsDelete === true ||
                    params.row.IsPrint === true ||
                    params.row.IsUpdate === true ||
                    params.row.IsView === true
                  }
                />
              ) : (
                <Fragment>
