...
class coaMaster extends React.Component {
    ...
    exportToPdf = () => {
        ...
        doc.autoTable({ html: '#coa-table',theme:'striped',styles: { fillColor: null,lineColor:'#000000' } });
        doc.setFontSize(12);
        doc.save('coa.pdf');
    }
                            ...
                            <div style={{ marginLeft: 10, marginTop: 1 }}>
                                ...
                                >
                                    <Button
                                        ...
                                        startIcon={<AddIcon />}
                                        onClick={(e) =>
                                            this.openPage(URLS.URLS.addCoa + this.state.urlparams + "&type=add")
                                        }
                                    >
                                        NEW
                                    </Button>
                            ...
                            <Grid xs={12} sm={12} md={11} lg={11}>
                                <div style={{ width: '100%', overflowX: 'scroll' }}>
                                    {this.state.COAList.length > 0 ? (
                                        <Fragment>
                                            <Table id="coa-table" stickyHeader size="small" className="" aria-label="table">
                                                <TableHead className="table-header-background">
                                                    <TableRow>
                                                        ...
                                                        <TableCell className="table-header-font" align="left">Acc.Sub.Cat</TableCell>
                                                ...
                                                <TableBody className="tableBody">
                                                    {getPageData(this.state.COAList).map((item, i) => (
                                                        ...
                                                        >
                                                            <TableCell className="table-header-font" align="left">{item.ACNo}  </TableCell>
                                                            <TableCell align="left">{i % 2 === 0 ? (<fragment>&nbsp;&nbsp;</fragment>) : null}{item.Name} </TableCell>
