        ...
        .then((response) => {
          if (response.status === 200) {
            ...
            this.setState({
              ...
              ShowLoader: false,
              newAdded: true,
              OldrowClicked: this.props.rowClicked,
            });
          }
        })
        .catch((error) => {
                ...
                <Grid xs={12} sm={12} md={11} lg={11}>
                  <TableContainer>
                    <Table
                      ...
                      size="small"
                      className=""
                      aria-label="Attachment Form table"
                    >
                      <TableRow>
          ...
          <div style={{ marginLeft: 10, marginTop: 20, marginBottom: 20 }}>
            {this.props.companyId ? (
              this.props.companyId > 0 ? (
                <Fragment>
                  {parseInt(this.props.rowClicked) >
                  parseInt(this.state.OldrowClicked) ? (
                    <Getattachments filelist={this.props.filelist} />
                  ) : this.state.newAdded === true ? (
